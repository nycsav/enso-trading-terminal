...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            dcc.Dropdown(
                id="main-symbol",
                options=[{"label": s, "value": s} for s in sorted(set(cfg.SYMBOLS + [
                    "BABA", "BAC", "C", "CRM", "DIS", "F", "GOOG", "GS", "HD",
                    "INTC", "JNJ", "JPM", "KO", "LLY", "MA", "MRK", "NFLX",
                    "NKE", "PEP", "PFE", "PLTR", "PYPL", "ROKU", "SHOP", "SNAP",
                    "SOFI", "SQ", "TGT", "UNH", "V", "WMT", "XOM", "IWM",
                    "DIA", "GLD", "TLT", "ARKK", "COIN", "RIVN", "NIO", "ABNB",
                    "UBER", "SNOW", "DDOG", "NET", "CRWD", "PANW",
                ]))],
                value="SPY",
                searchable=True,
